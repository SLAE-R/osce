...
int main(int argc, char *argv[]){
  ...
  17:	68 f0 07 00 00       	push   $0x7f0
  1c:	6a 02                	push   $0x2
  1e:	e8 19 04 00 00       	call   43c <printf>
  ...
  26:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	if (argc > 0) {
  2d:	83 3b 00             	cmpl   $0x0,(%ebx)
  30:	7e 17                	jle    49 <main+0x49>
	//	argptr(0, (char**)&head, sizeof(head));
		printf(1, "Received pointer is : %p\n", head);
  32:	83 ec 04             	sub    $0x4,%esp
  35:	ff 75 f4             	pushl  -0xc(%ebp)
  38:	68 01 08 00 00       	push   $0x801
  3d:	6a 01                	push   $0x1
  3f:	e8 f8 03 00 00       	call   43c <printf>
  44:	83 c4 10             	add    $0x10,%esp
  47:	eb 12                	jmp    5b <main+0x5b>
	//	printf(1, "Received jobId is : %d\n", head->backgroundjob);
	}
	else {
		printf(1, "No Arguments\n");
  49:	83 ec 08             	sub    $0x8,%esp
  4c:	68 1b 08 00 00       	push   $0x81b
  51:	6a 01                	push   $0x1
  53:	e8 e4 03 00 00       	call   43c <printf>
  58:	83 c4 10             	add    $0x10,%esp
	}

	return 123;
  5b:	b8 7b 00 00 00       	mov    $0x7b,%eax
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d9:	0f b6 80 88 0a 00 00 	movzbl 0xa88(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 514:	75 07                	jne    51d <printf+0xe1>
          s = "(null)";
 516:	c7 45 f4 29 08 00 00 	movl   $0x829,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5db:	a1 a4 0a 00 00       	mov    0xaa4,%eax
...
free(void *ap)
{
 ...
 6a6:	a3 a4 0a 00 00       	mov    %eax,0xaa4
}
 6ab:	c9                   	leave  
 6ac:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 703:	83 c4 10             	add    $0x10,%esp
  return freep;
 706:	a1 a4 0a 00 00       	mov    0xaa4,%eax
}
 70b:	c9                   	leave  
 70c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 71f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 722:	a1 a4 0a 00 00       	mov    0xaa4,%eax
 727:	89 45 f0             	mov    %eax,-0x10(%ebp)
 72a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 72e:	75 23                	jne    753 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 730:	c7 45 f0 9c 0a 00 00 	movl   $0xa9c,-0x10(%ebp)
 737:	8b 45 f0             	mov    -0x10(%ebp),%eax
 73a:	a3 a4 0a 00 00       	mov    %eax,0xaa4
 73f:	a1 a4 0a 00 00       	mov    0xaa4,%eax
 744:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    base.s.size = 0;
 ...
 7a6:	a3 a4 0a 00 00       	mov    %eax,0xaa4
      return (void*)(p + 1);
 ...
 7b1:	eb 3b                	jmp    7ee <malloc+0xe1>
    ...
    if(p == freep)
 7b3:	a1 a4 0a 00 00       	mov    0xaa4,%eax
