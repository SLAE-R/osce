...
main(int argc, char *argv[])
{
  ...
  52:	50                   	push   %eax
  53:	e8 ff 02 00 00       	call   357 <mkdir>
...
printf(int fd, char *fmt, ...)
{
 ...
 544:	75 07                	jne    54d <printf+0xe1>
          s = "(null)";
 546:	c7 45 f4 53 08 00 00 	movl   $0x853,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 60b:	a1 c4 0a 00 00       	mov    0xac4,%eax
...
free(void *ap)
{
 ...
 6d6:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 6db:	c9                   	leave  
 6dc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 733:	83 c4 10             	add    $0x10,%esp
  return freep;
 736:	a1 c4 0a 00 00       	mov    0xac4,%eax
}
 73b:	c9                   	leave  
 73c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d6:	a3 c4 0a 00 00       	mov    %eax,0xac4
      return (void*)(p + 1);
 ...
 7e1:	eb 3b                	jmp    81e <malloc+0xe1>
    ...
    if(p == freep)
 7e3:	a1 c4 0a 00 00       	mov    0xac4,%eax
